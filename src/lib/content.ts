...
export const clients = [
  { name: "Käefer", initials: "KÄ", logoSrc: "/logos/kaefer.svg" },
  { name: "Bredo Werft", initials: "BW", logoSrc: "/logos/bredo.png", logoVariant: "dark" },
  { name: "G+H Isolierung", initials: "G+H", logoSrc: "/logos/guh.png" },
  { name: "Weber Rohrleitungsbau", initials: "WR", logoSrc: "/logos/weber.svg" }
];
