  ...
  return (
    <header className="site-header">
      <div className="shell header-inner">
        ...
        <Link className="button button-small header-cta" href="/#kontakt">Projekt besprechen</Link>
      ...
      <nav id="mobile-navigation" className={`mobile-nav ${open ? "is-open" : ""}`} aria-label="Mobile Navigation">
        <div className="shell mobile-nav-inner">
          ...
          <Link className="button" href="/#kontakt" onClick={() => setOpen(false)}>Projekt besprechen</Link>
        </div>
      </nav>
